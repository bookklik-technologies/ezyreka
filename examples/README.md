...
repository (with WAMP: `http://localhost/ezyreka/examples/`, or the dev
...
from `dist/`. The only inline styles are host sizing.
...
| Advanced | [advanced.html](advanced.html) | Community plugin with custom element type and sidebar panel |
